  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white pt-28 px-4 md:px-12">
      ...
      {loading ? (
        ...
        <p className="text-center text-gray-600">Bạn chưa đăng ký lớp học nào.</p>
      ) : (
          ...
          {myClasses.map((cls, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-center mt-4">
                <span
                  className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusClass(cls.status)}`}
                >
                  {cls.status || "Chưa rõ"}
                </span>
